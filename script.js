...
canvas.width = 1024; // come from window
canvas.height = 576;
...
function animate() {
    ...
    invaderProjectiles.forEach((invaderProjectile, index) => {
        ...
        if ((invaderProjectile.position.y + invaderProjectile.height >= player.position.y) && (invaderProjectile.position.x + invaderProjectile.width >= player.position.x) && (invaderProjectile.position.x - invaderProjectile.width) <= player.position.x) {
            setTimeout(() => {
                invaderProjectiles.splice(index, 1);
            }, 0)
            setTimeout(() => {
